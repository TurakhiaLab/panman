...
if (True):
    ...
    data = [
        ["Sars-CoV-2", "20,000", "29,902", "0.0025","2.1","523.3X", "153.5X",  "17.1X", "614.4X"],
        ["HIV", "20,000", "9,299", "0.091","9.1", "135.1X", "42.2X",  "6.8X","49.6X"],
        [ "RSV", "4,000", "14,987", "0.123", "0.5","680.4X", "221.7X",  "5.2X", "234.8X"],
        ["E. Coli", "1,000", "4,641,650", "0.023","109.0","21.6X", "6.6X",  "7.9X", "30.5X"],
        [ "M. Tuberculosis", "400", "4,411,448",  "0.00093","5.0", "148.8X", "79.6X", "42.1X","80.4X"],
        [ "K. pneumoniae", "1,000", "5,328,875",  "0.023","204.0", "19.5X", "6.1X", "7.7X", "26.1X"]
