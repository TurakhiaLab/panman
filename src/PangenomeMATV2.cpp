...
void PangenomeMAT2::Tree::fillMutationMats(statsgenotype::mutationMatrices& mutmat, PangenomeMAT2::Node* node, ifstream* min_ptr) {
    if (min_ptr != nullptr) {
        string line;
        int idx = 0;
...
void PangenomeMAT2::Tree::printVCFGenotypeStats(std::ifstream& fin, std::ifstream* min) {
